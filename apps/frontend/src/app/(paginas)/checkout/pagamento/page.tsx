'use client'
import CabecalhoCheckout from '@/components/checkout/cabecalho-checkout'
import FormularioEntrega from '@/components/checkout/pagamento/formulario-entrega'
import ResumoPagamento from '@/components/checkout/pagamento/resumo-pagamento'
import SelecaoFormaPagamento from '@/components/checkout/pagamento/selecao-forma-pagamento'
